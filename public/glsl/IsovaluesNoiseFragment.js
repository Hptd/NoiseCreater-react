...
void main(){
  vec2 U = vec2((vUv.x+uvMoveX)*uvScaleX, (vUv.y+uvMoveY)*uvScaleY) * (uvScale*10.0);
    vec2 g;
    float n = noise(vec3(U,speed*iTime), g),
          v = sin(6.28*10.*n);
    g *= 6.28*10.*cos(6.28*10.*n) * 8./lineSize;
