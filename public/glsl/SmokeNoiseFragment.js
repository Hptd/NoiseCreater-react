...
void main(){
    ...
    color = mix(vec3(1., 1., 1.),vec3(colorGray1),clamp((f*f)*4.0,0.0,1.0)); // color1 111 | color2 000
    color = mix(color,vec3(colorGray2),clamp(length(q),0.0,1.0)); // color3 0.3
    color = mix(color,vec3(colorGray3),clamp(length(r.x),0.0,1.0)); // color4 0.6
